        ...
        <>
            <div id="container">
                <div className="playoff"><Navbar></Navbar>
                    ...
                    <hr/>
                    <div className="round1" onMouseEnter={() => handleMouseEnter("round1")}
                         onMouseLeave={() => handleMouseLeave("round1")}>
                        <img width="" height="" alt="" className={`${hoveredDivs["round1"] ? 'bg-zinc-500' : ''}`}/>
                        <div className={`${hoveredDivs["round1"] ? 'hidden' : 'block'}`}>
                            <div className="team west1"><a href="#" target="_blank"><img src="Images/Suns.png" width=""
                                                                                         height="" alt=""/>
                                <span>PHX</span></a></div>
                            <div className="team west2"><a href="#" target="_blank"><img src="Images/Pelicans.png"
                                                                                         width="" height="" alt=""/> NOP</a>
                            </div>
                            <p><a href="#" target="_blank"> PHX 4:2 NOP</a></p>
                        </div>
                        <div
                            className={`${hoveredDivs["round1"] ? 'block' : 'hidden'} absolute top-0 left-0 w-[130px] text-[10px] flex flex-col p-4 text-white `}>
                    ...
                    <div className="round2" onMouseEnter={() => handleMouseEnter("round2")}
                         onMouseLeave={() => handleMouseLeave("round2")}>
                        <img width="" height="" alt="" className={`${hoveredDivs["round2"] ? 'bg-zinc-500' : ''}`}/>
                        <div className={`${hoveredDivs["round2"] ? 'hidden' : 'block'}`}>
                            <div className="team west3"><a href="#" target="_blank"><img src="Images/Mavericks.png"
                                                                                         width="" height="" alt=""/> DAL</a>
                            </div>
                            <div className="team west4"><a href="#" target="_blank"><img src="Images/Jazz.png" width=""
                                                                                         height="" alt=""/> UTA</a>
                            </div>
                            <p><a href="#" target="_blank"> DAL 4:2 UTA</a></p>
                        </div>
                        <div
                            className={`${hoveredDivs["round2"] ? 'block' : 'hidden'} absolute top-0 left-0 w-[130px] text-[10px] flex flex-col p-4 text-white `}>
                    ...
                    <div className="round3" onMouseEnter={() => handleMouseEnter("round3")}
                         onMouseLeave={() => handleMouseLeave("round3")}>
                        <img width="" height="" alt="" className={`${hoveredDivs["round3"] ? 'bg-zinc-500' : ''}`}/>
                        <div className={`${hoveredDivs["round3"] ? 'hidden' : 'block'}`}>
                            <div className="team west5"><a href="#" target="_blank"><img src="Images/Warriors.png"
                                                                                         width="" height="" alt=""/> GSW</a>
                            </div>
                            <div className="team west6"><a href="#" target="_blank"><img src="Images/Nuggets.png"
                                                                                         width="" height="" alt=""/> DEN</a>
                            </div>
                            <p><a href="#" target="_blank"> GSW 4:1 DEN</a></p>
                        </div>
                        <div
                            className={`${hoveredDivs["round3"] ? 'block' : 'hidden'} absolute top-0 left-0 w-[130px] text-[10px] flex flex-col p-4 text-white `}>
                    ...
                    <div className="round4" onMouseEnter={() => handleMouseEnter("round4")}
                         onMouseLeave={() => handleMouseLeave("round4")}>
                        <img width="" height="" alt="" className={`${hoveredDivs["round4"] ? 'bg-zinc-500' : ''}`}/>
                        <div className={`${hoveredDivs["round4"] ? 'hidden' : 'block'}`}>
                            <div className="team west7"><a href="#" target="_blank"><img src="Images/Grizzlies.png"
                                                                                         width="" height="" alt=""/> MEM</a>
                            </div>
                            <div className="team west8"><a href="#" target="_blank"><img src="Images/Timberwolves.png"
                                                                                         width="" height="" alt=""/> MSP</a>
                            </div>
                            <p><a href="#" target="_blank"> MEM 4:2 MSP</a></p>
                        </div>
                        <div
                            className={`${hoveredDivs["round4"] ? 'block' : 'hidden'} absolute top-0 left-0 w-[130px] text-[10px] flex flex-col p-4 text-white `}>
                    ...
                    <div className="round5" onMouseEnter={() => handleMouseEnter("round5")}
                         onMouseLeave={() => handleMouseLeave("round5")}>
                        <img width="" height="" alt="" className={`${hoveredDivs["round5"] ? 'bg-zinc-500' : ''}`}/>
                        <div className={`${hoveredDivs["round5"] ? 'hidden' : 'block'}`}>
                            <div className="team west9"><a href="#" target="_blank"><img src="Images/Suns.png" width=""
                                                                                         height="" alt=""/> PHX</a>
                            </div>
                            <div className="team west10"><a href="#" target="_blank"><img src="Images/Mavericks.png"
                                                                                          width="" height=""
                                                                                          alt=""/> DAL</a></div>
                            <p><a href="#" target="_blank"> PHX 3:4 DAL</a></p>
                        </div>
                        <div
                            className={`${hoveredDivs["round5"] ? 'block' : 'hidden'} absolute top-0 left-0 w-[130px] text-[10px] flex flex-col p-4 text-white`}>
                    ...
                    <div className="round6" onMouseEnter={() => handleMouseEnter("round6")}
                         onMouseLeave={() => handleMouseLeave("round6")}>
                        <img width="" height="" alt="" className={`${hoveredDivs["round6"] ? 'bg-zinc-500' : ''}`}/>
                        <div className={`${hoveredDivs["round6"] ? 'hidden' : 'block'}`}>
                            <div className="team west11"><a href="#" target="_blank"><img src="Images/Warriors.png"
                                                                                          width="" height=""
                                                                                          alt=""/> GSW</a></div>
                            <div className="team west12"><a href="#" target="_blank"><img src="Images/Grizzlies.png"
                                                                                          width="" height=""
                                                                                          alt=""/> MEM</a></div>
                            <p><a href="#" target="_blank"> GSW 4:2 MEM</a></p>
                        </div>
                        <div
                            className={`${hoveredDivs["round6"] ? 'block' : 'hidden'} absolute top-0 left-0 w-[130px] text-[10px] flex flex-col p-4 text-white `}>
                    ...
                    <div className="round7" onMouseEnter={() => handleMouseEnter("round7")}
                         onMouseLeave={() => handleMouseLeave("round7")}>
                        <img width="" height="" alt="" className={`${hoveredDivs["round7"] ? 'bg-zinc-500' : ''}`}/>
                        <div className={`${hoveredDivs["round7"] ? 'hidden' : 'block'}`}>
                            <div className="team west13"><a href="#" target="_blank"><img src="Images/Mavericks.png"
                                                                                          width="" height=""
                                                                                          alt=""/> DAL</a></div>
                            <div className="team west14"><a href="#" target="_blank"><img src="Images/Warriors.png"
                                                                                          width="" height=""
                                                                                          alt=""/> GSW</a></div>
                            <p><a href="#" target="_blank"> DAL 1: 4 GSW</a></p>
                        </div>
                        <div
                            className={`${hoveredDivs["round7"] ? 'block' : 'hidden'} absolute top-0 left-0 w-[130px] text-[10px] flex flex-col p-4 text-white `}>
                    ...
                    <div className="round8" onMouseEnter={() => handleMouseEnter("round8")}
                         onMouseLeave={() => handleMouseLeave("round8")}>
                        <img width="" height="" alt="" className={`${hoveredDivs["round8"] ? 'bg-zinc-500' : ''}`}/>
                        <div className={`${hoveredDivs["round8"] ? 'hidden' : 'block'}`}>
                            <div className="team east13"><a href="#" target="_blank"><img src="Images/Heat.png" width=""
                                                                                          height="" alt=""/> MIA</a>
                            </div>
                            <div className="team east14"><a href="#" target="_blank"><img src="Images/Celtics.png"
                                                                                          width="" height=""
                                                                                          alt=""/> BOS</a></div>
                            <p><a href="#" target="_blank"> MIA 3:4 BOS</a></p>
                        </div>
                        <div
                            className={`${hoveredDivs["round8"] ? 'block' : 'hidden'} absolute top-0 left-0 w-[130px] text-[10px] flex flex-col p-4 text-white `}>
                    ...
                    <div className="round9" onMouseEnter={() => handleMouseEnter("round9")}
                         onMouseLeave={() => handleMouseLeave("round9")}>
                        <img width="" height="" alt="" className={`${hoveredDivs["round9"] ? 'bg-zinc-500' : ''}`}/>
                        <div className={`${hoveredDivs["round9"] ? 'hidden' : 'block'}`}>
                            <div className="team east9"><a href="#" target="_blank"><img src="Images/Heat.png" width=""
                                                                                         height="" alt=""/> MIA</a>
                            </div>
                            <div className="team east10"><a href="#" target="_blank"><img src="Images/76ers.png"
                                                                                          width="" height=""
                                                                                          alt=""/> PHI</a></div>
                            <p><a href="#" target="_blank"> MIA 4:2 PHI</a></p>
                        </div>
                        <div
                            className={`${hoveredDivs["round9"] ? 'block' : 'hidden'} absolute top-0 left-0 w-[130px] text-[10px] flex flex-col p-4 text-white `}>
                    ...
                    <div className="round10" onMouseEnter={() => handleMouseEnter("round10")}
                         onMouseLeave={() => handleMouseLeave("round10")}>
                        <img width="" height="" alt="" className={`${hoveredDivs["round10"] ? 'bg-zinc-500' : ''}`}/>
                        <div className={`${hoveredDivs["round10"] ? 'hidden' : 'block'}`}>
                            <div className="team east11"><a href="#" target="_blank"><img src="Images/Bucks.png"
                                                                                          width="" height=""
                                                                                          alt=""/> MIL</a></div>
                            <div className="team east12"><a href="#" target="_blank"><img src="Images/Celtics.png"
                                                                                          width="" height=""
                                                                                          alt=""/> BOS</a></div>
                            <p><a href="#" target="_blank"> MIL 3:4 BOS</a></p>
                        </div>
                        <div
                            className={`${hoveredDivs["round10"] ? 'block' : 'hidden'} absolute top-0 left-0 w-[130px] text-[10px] flex flex-col p-4 text-white `}>
                    ...
                    <div className="round11" onMouseEnter={() => handleMouseEnter("round11")}
                         onMouseLeave={() => handleMouseLeave("round11")}>
                        <img width="" height="" alt="" className={`${hoveredDivs["round11"] ? 'bg-zinc-500' : ''}`}/>
                        <div className={`${hoveredDivs["round11"] ? 'hidden' : 'block'}`}>
                            <div className="team east1"><a href="#" target="_blank"><img src="Images/Heat.png" width=""
                                                                                         height="" alt=""/> MIA</a>
                            </div>
                            <div className="team east2"><a href="#" target="_blank"><img src="Images/Hawks.png" width=""
                                                                                         height="" alt=""/> ATL</a>
                            </div>
                            <p><a href="#" target="_blank"> MIA 4:1 ATL</a></p>
                        </div>
                        <div
                            className={`${hoveredDivs["round11"] ? 'block' : 'hidden'} absolute top-0 left-0 w-[130px] text-[10px] flex flex-col p-4 text-white `}>
                    ...
                    <div className="round12" onMouseEnter={() => handleMouseEnter("round12")}
                         onMouseLeave={() => handleMouseLeave("round12")}>
                        <img width="" height="" alt="" className={`${hoveredDivs["round12"] ? 'bg-zinc-500' : ''}`}/>
                        <div className={`${hoveredDivs["round12"] ? 'hidden' : 'block'}`}>
                            <div className="team east3"><a href="#" target="_blank"><img src="Images/76ers.png" width=""
                                                                                         height="" alt=""/> PHI</a>
                            </div>
                            <div className="team east4"><a href="#" target="_blank"><img src="Images/Raptors.png"
                                                                                         width="" height="" alt=""/> TOR</a>
                            </div>
                            <p><a href="#" target="_blank"> PHI 4:2 TOR</a></p>
                        </div>
                        <div
                            className={`${hoveredDivs["round12"] ? 'block' : 'hidden'} absolute top-0 left-0 w-[130px] text-[10px] flex flex-col p-4 text-white `}>
                    ...
                    <div className="round13" onMouseEnter={() => handleMouseEnter("round13")}
                         onMouseLeave={() => handleMouseLeave("round13")}>
                        <img width="" height="" alt="" className={`${hoveredDivs["round13"] ? 'bg-zinc-500' : ''}`}/>
                        <div className={`${hoveredDivs["round13"] ? 'hidden' : 'block'}`}>
                            <div className="team east5"><a href="#" target="_blank"><img src="Images/Bucks.png" width=""
                                                                                         height="" alt=""/> MIL</a>
                            </div>
                            <div className="team east6"><a href="#" target="_blank"><img src="Images/Bulls.png" width=""
                                                                                         height="" alt=""/> CHI</a>
                            </div>
                            <p><a href="#" target="_blank"> MIL 4:1 CHI</a></p>
                        </div>
                        <div
                            className={`${hoveredDivs["round13"] ? 'block' : 'hidden'} absolute top-0 left-0 w-[130px] text-[10px] flex flex-col p-4 text-white `}>
                    ...
                    <div className="round14" onMouseEnter={() => handleMouseEnter("round14")}
                         onMouseLeave={() => handleMouseLeave("round14")}>
                        <img width="" height="" alt="" className={`${hoveredDivs["round14"] ? 'bg-zinc-500' : ''}`}/>
                        <div className={`${hoveredDivs["round14"] ? 'hidden' : 'block'}`}>
                            <div className="team east7"><a href="#" target="_blank"><img src="Images/Celtics.png"
                                                                                         width="" height="" alt=""/> BOS</a>
                            </div>
                            <div className="team east8"><a href="#" target="_blank"><img src="Images/Nets.png" width=""
                                                                                         height="" alt=""/> BKN</a>
                            </div>
                            <p><a href="#" target="_blank"> BOS 4:0 BKN</a></p>
                        </div>
                        <div
                            className={`${hoveredDivs["round14"] ? 'block' : 'hidden'} absolute top-0 left-0 w-[130px] text-[10px] flex flex-col p-4 text-white `}>
                    ...
                    <div className="round15" onMouseEnter={() => handleMouseEnter("round15")}
                         onMouseLeave={() => handleMouseLeave("round15")}>
                        <img width="" height="" alt="" className={`${hoveredDivs["round15"] ? 'bg-zinc-500' : ''}`}/>
                        <div className={`${hoveredDivs["round15"] ? 'hidden' : 'block'}`}>
                            <div className="team runner-up"><a href="#" target="_blank"><img src="Images/Celtics.png"
                                                                                             width="" height=""
                                                                                             alt=""/> BOS</a></div>
                            <div className="team champion"><a href="#" target="_blank"><img src="Images/Warriors.png"
                                                                                            width="" height=""
                                                                                            alt=""/> GSW</a></div>
                            <p><a href="#" target="_blank"> BOS 2:4 GSW</a></p>
                        </div>
                        <div
                            className={`${hoveredDivs["round15"] ? 'block' : 'hidden'} absolute top-0 left-0 w-[130px] text-[10px] flex flex-col p-4 text-white `}>
                            ...
                            <div className="flex justify-between"><span>6-17</span><span><a href={`/detail`}>110-90</a></span></div>
                        </div>
                        {/*添加连接线条*/}
