...
const Ranking = () => {
  ...
  const teamData = {
    ...
    Illinois: [{ name: 'Chicago Bulls', wins: 31, icon: 'Images/Bulls.png' }],
    Ohio: [
    ...
    Georgia: [{ name: 'Atlanta Hawks', wins: 41, icon: 'Images/Hawks.png' }],
    Massachusetts: [
      { name: 'Boston Celtics', wins: 36, icon: 'Images/Celtics.png' },
    ],
    Indiana: [{ name: 'Indiana Pacers', wins: 34, icon: 'Images/Pacers.png' }],
    Wisconsin: [
    ...
    Utah: [{ name: 'Utah Jazz', wins: 52, icon: 'Images/Jazz.png' }],
    Louisiana: [
      { name: 'New Orleans Pelicans', wins: 31, icon: 'Images/Pelicans.png' },
    ],
    Arizona: [{ name: 'Phoenix Suns', wins: 51, icon: 'Images/Suns.png' }],
    'North Carolina': [
    ...
    Canada: [{ name: 'Toronto Raptors', wins: 27, icon: 'Images/Raptors.png' }],
  }
  ...
  const colorScale = d3.scaleSequential(d3.interpolateRdYlBu).domain([60, 10])
      ...
      series: [
        {
          ...
          markPoint: {
            ...
            tooltip: {
              formatter: (params) => {
                const team =
                  markPointData.find((t) => t.name === params.name) || {}
                return (
                  '<div><img src="' +
                  team.icon +
                  '" style="width:30px;height:30px;vertical-align:middle;margin-right:5px;" alt="' +
